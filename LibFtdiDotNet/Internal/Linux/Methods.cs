...
namespace LibFtdiDotNet.Internal.Linux
{
    internal static class Methods
    {
        ...
        [DllImport(LIBRARY_FILENAME)]
        public static extern unsafe FT_STATUS ftdi_read_data(ref ftdi_context /*struct ftdi_context*/ ftdi, byte* buf,
            int size);

        [DllImport(LIBRARY_FILENAME)]
        public static extern unsafe int ftdi_write_data(ref ftdi_context /*struct ftdi_context*/ ftdi, byte* buf,
            int size);
        ...
        [DllImport(LIBRARY_FILENAME)]
        public static extern FT_STATUS ftdi_set_line_property(ref ftdi_context ftdi, BitsPerWord bits,
            StopBits stopBits, Parity parity);

        [DllImport(LIBRARY_FILENAME)]
        public static extern FT_STATUS ftdi_set_line_property2(ref ftdi_context ftdi, BitsPerWord bits,
            StopBits stopBits, Parity parity, bool break_on);
        ...
        [DllImport(LIBRARY_FILENAME)]
        public static extern unsafe FT_STATUS ftdi_usb_find_all(ref ftdi_context ftdi, ftdi_device_list* devList,
        ...
        [DllImport(LIBRARY_FILENAME)]
        public static extern FT_STATUS ftdi_usb_open_desc(ref ftdi_context ftdi, int vendor, int product,
            string description,
            string serial);
        ...
        [DllImport(LIBRARY_FILENAME)]
        public static extern unsafe FT_STATUS ftdi_read_data_get_chunksize(ref ftdi_context ftdi, byte* chunksize);

        [DllImport(LIBRARY_FILENAME)]
        public static extern FT_STATUS ftdi_write_data_set_chunksize(ref ftdi_context ftdi, uint chunksize);

        [DllImport(LIBRARY_FILENAME)]
        public static extern unsafe FT_STATUS ftdi_write_data_get_chunksize(ref ftdi_context ftdi, uint* chunksize);

        [DllImport(LIBRARY_FILENAME)]
        public static extern FT_STATUS ftdi_set_latency_timer(ref ftdi_context ftdi, byte latency);

        [DllImport(LIBRARY_FILENAME)]
        public static extern unsafe FT_STATUS ftdi_get_latency_timer(ref ftdi_context ftdi, byte* latency);
        ...
        [DllImport(LIBRARY_FILENAME)]
        public static extern FT_STATUS ftdi_set_interface(ref ftdi_context ftdi, FtdiInterface @interface);

        [DllImport(LIBRARY_FILENAME)]
        public static extern unsafe FT_STATUS ftdi_read_pins(ref ftdi_context ftdi, byte* pins);

        [DllImport(LIBRARY_FILENAME)]
        public static extern unsafe FT_STATUS ftdi_list_free(ref ftdi_context ftdi, ftdi_device_list* devlist);
    }
}